class Student < ApplicationRecord
  ...
  store_accessor :data, :uga_my_id, :first_name, :last_name, :matriculation_term, :graduation_term, :programs, :program_code, :program_name, :program_type, :credit_hrs, :pre_professional
